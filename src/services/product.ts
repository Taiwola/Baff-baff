...
export async function getAllProducts(filter?: FilterQuery<IProduct>): Promise<IProduct[]> {
...
export async function updateProduct(id: string, data: UpdateProductDto): Promise<IProduct | null> {
