    ...
    <div className="py-12 w-full">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row w-full gap-6 md:gap-4">
          <div className="flex flex-col gap-6 md:gap-4 w-full md:w-fit md:text-left  md:justify-center">
            <h2 className="font-roboto font-normal text-base text-black md:font-black md:text-3xl">
              Our Story
            </h2>
