...
export default function CollaboratorsList({ promise }: Props) {
   ...
   return (
      <section className="w-full h-full">
         <div className="bg-white rounded-[1.25rem] min-h-screen py-7.5 px-14.5 w-full h-full grid gap-7.5 mb-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
