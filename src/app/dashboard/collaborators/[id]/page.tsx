...
export default async function CollaboratorPage({ params }: Props) {
   ...
   return (
      <div className="w-full h-auto">
         ...
         <section className="flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-10 py-10 px-4 sm:px-6 border-b border-brand-dark/20">
            {/* Profile + Info Container */}
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 w-full">
               {/* Profile Image */}
               <div className="relative w-[120px] h-[120px] sm:w-[160px] sm:h-[160px] rounded-full overflow-hidden shadow-md flex-shrink-0">
                  <Image
               ...
               <div className="flex flex-col gap-4 text-center sm:text-left">
                  ...
                  {/* Social links */}
                  <div className="flex items-center justify-center sm:justify-start gap-4 text-gray-600 flex-wrap">
                  ...
                  <p className="text-sm text-gray-500">
                     Joined on{" "}
                     {new Date(collaborator.createdAt).toLocaleDateString("en-GB", {
                        day: "numeric",
                        month: "short",
                        year: "numeric",
                     })}
            ...
            <div className="w-full flex justify-center sm:justify-end">
               <Button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-brand-dark text-white rounded-lg hover:bg-brand-dark/90 transition"
               >
                  <Pencil size={16} />
                  Edit Collaborator
               </Button>
