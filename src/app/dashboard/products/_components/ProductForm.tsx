    ...
    <form ref={formRef} className="w-full h-auto" onSubmit={handleSubmit}>
      <div className="w-full flex justify-between items-start">
        ...
        <div className="flex justify-end items-center gap-2.5">
          {type === 'edit' ? (
            <Button type="button" variant="danger" rounded="sm" className="max-w-32.25 text-sm" onClick={onDelete} disabled={isDeleting || pending}>
              {isDeleting ? 'Deleting...' : 'Delete'}
            </Button>
          ) : null}

          <Button onClick={onOpen} type="button" rounded="sm" className="w-32.25 text-sm">
            {'Save Product'}
          </Button>
        </div>
      </div>
      ...
      <section className="w-full rounded-xl px-5 py-2.5 bg-white">
        ...
        <div className="w-full mt-7.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full">
            <Input label="PRODUCT NAME" name="name" value={initialState.name} error={errors.name} />
            ...
            <Input label="YARD ALLOCATION" name="yard" type="number" value={initialState.yard} error={errors.yard} />
          </div>
        </div>
        ...
        <div className="w-full mt-7.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full mb-5">
            ...
            <Input name="s[price]" label="Price" placeholder="NGN" type="number" value={initialState.s?.price} error={errors.s?.price} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full mb-5">
            ...
            <Input name="m[price]" label="Price" placeholder="NGN" type="number" value={initialState.m?.price} error={errors.m?.price} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full mb-5">
            ...
            <Input name="l[price]" label="Price" placeholder="NGN" type="number" value={initialState.l?.price} error={errors.l?.price} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full mb-5">
            ...
            <Input name="xl[price]" label="Price" placeholder="NGN" type="number" value={initialState.xl?.price} error={errors.xl?.price} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full mb-5">
            ...
            <Input name="xxl[price]" label="Price" placeholder="NGN" type="number" value={initialState.xxl?.price} error={errors.xxl?.price} />
        ...
        <div className="w-full mt-7.5">
          ...
          <Input type="textarea" name="description" value={initialState.description} error={errors.description} />
        </div>
      </section>
      {isOpen ? (
        <SaveProductModal
